...
export const TRACKS = {
  ...
  track6: {
    ...
    status: 'completed',
    practiceHistory: [
      { week: 1, date: '26.01.08', sound: new URL('./sound/track6/week1.m4a', import.meta.url).href },
      { week: 2, date: '26.01.22', sound: new URL('./sound/track6/week2.m4a', import.meta.url).href },
